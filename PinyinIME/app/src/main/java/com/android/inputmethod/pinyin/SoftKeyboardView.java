...
public class SoftKeyboardView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (null != mSoftKeyboard) {
            ...
            measuredWidth += Config.mPaddingLeft + Config.mPaddingRight;
            measuredHeight += Config.mPaddingTop + Config.mPaddingBottom;
        }
    ...
    public SoftKey onKeyPress(int x, int y,
        ...
        if (null != mBalloonOnKey) {
            ...
            mHintLocationToSkbContainer[0] = Config.mPaddingLeft + mSoftKeyDown.mLeft
                    - (mBalloonOnKey.getWidth() - mSoftKeyDown.width()) / 2;
            mHintLocationToSkbContainer[0] += mOffsetToSkbContainer[0];
            mHintLocationToSkbContainer[1] = Config.mPaddingTop
        ...
        if (mSoftKeyDown.needBalloon()) {
            ...
            mHintLocationToSkbContainer[0] += mOffsetToSkbContainer[0];
            mHintLocationToSkbContainer[1] = Config.mPaddingTop + mSoftKeyDown.mTop
    ...
    public SoftKey onKeyRelease(int x, int y) {
        ...
        if (mSoftKeyDown.moveWithinKey(x - Config.mPaddingLeft, y - Config.mPaddingTop)) {
            return mSoftKeyDown;
        }
        return null;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.translate(Config.mPaddingLeft, Config.mPaddingTop);
        ...
        for (int row = 0; row < rowNum; row++) {
            SoftKeyboard.KeyRow keyRow = mSoftKeyboard.getKeyRowForDisplay(row);
