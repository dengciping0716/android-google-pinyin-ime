...
//        mActiveCellDrawable = r.getDrawable(R.drawable.candidate_hl_bg);
    ...
    private void onSizeChanged() {
        mContentWidth = getMeasuredWidth() - Config.mPaddingLeft - Config.mPaddingRight;
        mContentHeight = (int) ((getMeasuredHeight() - Config.mPaddingTop - Config.mPaddingBottom) * 0.95f);
        /**
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float xPos = Config.mPaddingLeft;
        ...
        for (int i = 0; i < pSize; i++) {
            ...
            if (mActiveCandInPage == i && mEnableActiveHighlight) {
                mActiveCellRect.set(xPos, Config.mPaddingTop + 1, xPos
                        + itemTotalWidth, getHeight() - Config.mPaddingBottom - 1);
    ...
    private float drawVerticalSeparator(Canvas canvas, float xPos) {
        mSeparatorDrawable.setBounds((int) xPos, Config.mPaddingTop, (int) xPos
                + mSeparatorDrawable.getIntrinsicWidth(), getMeasuredHeight()
                - Config.mPaddingBottom);
...
//                .get(mDecInfo.mPageStart.get(mPageNo) + candPos), Config.showBalloonTextSize, true,
