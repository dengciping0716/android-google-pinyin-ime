...
public class Environment {
    ...
    private static final float KEY_HEIGHT_RATIO_PORTRAIT = 0.060f;
    ...
    private static final float CANDIDATES_AREA_HEIGHT_RATIO_PORTRAIT = 0.048f;
    ...
    private static final float KEY_BALLOON_WIDTH_PLUS_RATIO = 0.045f;
    ...
    private static final float KEY_BALLOON_HEIGHT_PLUS_RATIO = 0.039f;
    ...
    private static final float NORMAL_KEY_TEXT_SIZE_RATIO = 0.042f;
    ...
    private static final float FUNCTION_KEY_TEXT_SIZE_RATIO = 0.031f;
    ...
    private static final float NORMAL_BALLOON_TEXT_SIZE_RATIO = 0.079f;
    ...
    private static final float FUNCTION_BALLOON_TEXT_SIZE_RATIO = 0.048f;
